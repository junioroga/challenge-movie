...
describe('IntervalAwardsProducersItem', () => {
  ...
  it('deve renderizar corretamente com os dados do produtor', () => {
    const { getByText } = render(<IntervalAwardsProducersItem item={mockItem} />)
  ...
  it('deve renderizar o nome do produtor com numberOfLines={1}', () => {
    ...
    const { getByText } = render(<IntervalAwardsProducersItem item={longNameItem} />)
  ...
  it('deve aplicar os estilos corretos no container', () => {
    const { getByTestId } = render(<IntervalAwardsProducersItem item={mockItem} />)
